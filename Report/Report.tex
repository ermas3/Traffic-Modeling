...
was set to $p=0.2$. The cars were initally placed one unit length ahead of each other evenly distributed in the different lanes according to figure ... %TODO!!%.
Note that these simulation parameters and initial conditions are going to remained unchanged during all following simulations.

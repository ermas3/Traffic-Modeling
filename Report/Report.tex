...
\ref*{standard error} that increasing the number of lanes generally appeared to increase the fluctuations of the flow rate.

In order to determine if these results actually hold in real life traffic flow real life traffic data would have to be analyzed and compared to the model results.
...
appears to increase the flow rate by a constant amount for each additional lane.
...
inevitably increases the fluctuations of the flow rate, resulting in a trade-off between high flow rate and low fluctuations of the flow rate.
In order to determine whether this correlation between the flow rate and the fluctuations of the flow rate appears in real life traffic, the model would have to be compared
